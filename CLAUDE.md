...
```mermaid
graph TD
  9627ffcf["ERC-721 NFT"]
  6e176151["Frontend"]
  74be6d21["Wallet Auth"]
  9627ffcf --> 6e176151
  6e176151 --> 74be6d21
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--9627ffcf.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--6e176151.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--74be6d21.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--9627ffcf.md)
- [Frontend](.nskills/components/frontend-scaffold--6e176151.md)
- [Wallet Auth](.nskills/components/wallet-auth--74be6d21.md)
